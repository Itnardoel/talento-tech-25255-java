...
public class Articulo {
  ...
  // Es una forma de proteger los datos de una clase, restringiendo el acceso directo a sus
  // atributos.
  ...
  // constructor sin parametros por defecto que crea java automaticamente y solo crea una instancia
  // en memoria sin inicializar atributos

  // Los constructores son metodos especiales que se llaman cuando se crea una instancia de una
  // clase
  ...
  // Los constructores no son methods static porque se llaman cuando se crea una instancia de la
  // clase
  ...
  // ejemplo: si queremos mostrar el nombre y el precio del articulo, podemos sobreescribir
  // toString()
